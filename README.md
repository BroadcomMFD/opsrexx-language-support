...
<details><summary><span style="font-size: 1.3em">REXX Language Support Extension</span><hr></summary>
...
<details>
<summary><span style="font-size: 1.3em">OPS/MVS REST API</span><hr></summary>
...
<details>
<summary><span style="font-size: 1.3em">Zowe Explorer</span><hr></summary>
...
<details><summary><span style="font-size: 1.3em">Security Requirements</span><hr></summary>
...
<details><summary><span style="font-size: 1.3em">Customize Extension Settings</span><hr></summary>
...
5. If you are connecting to OPS/MVS using the REST API, go to the next section.  
   If you are connecting to OPS/MVS using SSH, refer to the section "Configure OPS/REXX LS for Access to OPS/MVS Using SSH." 
   
</details>

<details><summary><span style="font-size: 1.3em">Configure OPS/REXX LS for Access to OPS/MVS Using the REST API</span><hr></summary>
...
<details><summary><span style="font-size: 1.3em">Configure OPS/REXX LS for Use with Zowe Explorer</span><hr></summary>
...
<details><summary><span style="font-size: 1.3em">Configure OPS/REXX LS for Access to OPS/MVS Using SSH</span><hr></summary>
...
2.  Create an OPSVSCE SSH connection profile.       
    ...
    **Note:** If you do not create an SSH profile during setup, and you attempt to issue a command using an SSH connection, you will be prompted to create a profile.
    ...
    1. Use the VS Code Command Palette to issue the command **OPS/MVS: Create or Modify OPS/REXX LS SSH Connection Profiles**.  
...
<details><summary><span style="font-size: 1.5em"><b>Use OPS/REXX LS</b></span><hr></summary>
...
<details>
<summary><span style="font-size: 1.2em"><b>OPS/REXX Hover Insights</b></span><hr></summary>
...
<details><summary><span style="font-size: 1.2em"><b>Autocompletion</b></span><hr></summary>
...
<details><summary><span style="font-size: 1.2em"><b>OPS/REXX Snippets</b></span><hr></summary>
...
<details><summary><span style="font-size: 1.2em"><b>OPS/MVS Commands</b></span><hr></summary>
...
<details><summary><span style="font-size: 1.2em"><b>OPS/MVS Automation Samples</b></span><hr></summary>
...
<details><summary><span style="font-size: 1.5em"><b>Privacy Notice</b></span><hr></summary>
...
<details><summary><span style="font-size: 1.5em"><b>Technical Assistance and Support</b></span><hr></summary>
